...
The example requires valid OAuth2 credentials. Create an app in the [Developer Console](https://dev-console.quran.foundation/projects) and register `http://localhost:3000/callback` as your redirect URI.
:::

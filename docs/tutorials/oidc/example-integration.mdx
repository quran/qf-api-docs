...
The example requires valid OAuth2 credentials. [Create an app in Developer Console](https://dev-console.quran.foundation/projects/new) and register `http://localhost:3000/callback` as a redirect URI.
:::

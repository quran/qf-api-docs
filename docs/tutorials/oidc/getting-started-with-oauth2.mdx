...
Do not start here if you only need a working JavaScript app or a high-level User APIs architecture decision. For those paths, use [Starter With NPX](/docs/tutorials/oidc/starter-with-npx) or the [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart).

## Fastest Way To Start

For a production-style JavaScript starter with OAuth2, reader, search, notes, and bookmarks already wired together, use [Starter With NPX](/docs/tutorials/oidc/starter-with-npx).
...
This page owns the manual implementation details. The [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart) owns the recommended architecture and minimal successful User API call.

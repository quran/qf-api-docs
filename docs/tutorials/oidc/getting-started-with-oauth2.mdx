...
> Most Request Access clients should use a frontend/native app for login + PKCE, and a backend for token exchange and refresh. Never embed `client_secret` in a browser or mobile app.

...
Use this page when you need to implement the OAuth2/OIDC flow manually, adapt it for a mobile app, or understand the underlying token behavior.
...
Use this tutorial when you need to implement Quran Foundation OAuth2 yourself, inspect the token exchange details, or adapt the login flow for a custom backend or mobile app.

If you want a complete JavaScript app, start with [Starter With NPX](/docs/tutorials/oidc/starter-with-npx). If you only need app-level Quran content, start with the [Content APIs Quickstart](/docs/quickstart).

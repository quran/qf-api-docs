...
┌─────────────────────────────────────────────────────────────────┐
│  Your App ─┬─► Your Auth Server ─► Your User Database           │
│            │   (you maintain)       (you maintain)              │
│            └─► QF Content APIs (no user context)                │
│                                                                  │
...
┌─────────────────────────────────────────────────────────────────┐
│  Your App ───► QF OAuth2 ───► QF User APIs (bookmarks, goals)   │
│                    │                                             │
│                    └───► QF Content APIs (verses, translations) │
│                                                                  │
│  Benefits: SSO, synced data, zero user management               │
└─────────────────────────────────────────────────────────────────┘
```

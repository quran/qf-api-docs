...
Please submit an [Application](https://docs.google.com/forms/d/e/1FAIpQLScok67i1L-0rFhw7I3rqkfIKJLVxmcQyE61C_FHRqc-pA5U-w/viewform) to get your client credentials.
...
Submit an [Application](https://docs.google.com/forms/d/e/1FAIpQLScok67i1L-0rFhw7I3rqkfIKJLVxmcQyE61C_FHRqc-pA5U-w/viewform) to obtain OAuth 2.0 credentials such as a client ID and client secret that are known to both Quran.Foundation and your application. The set of values varies based on what type of application you are building. For example, a JavaScript application does not require a secret, but a web server application does.

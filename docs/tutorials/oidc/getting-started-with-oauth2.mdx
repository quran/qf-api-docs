...
Use this tutorial when you need to implement the OAuth2/OIDC flow manually, adapt it for a mobile app, or debug token exchange, refresh, scopes, and OpenID Connect validation.

Do not start here if you only need a working JavaScript app or the SDK path for an existing app. For those paths, use [Starter With NPX](/docs/tutorials/oidc/starter-with-npx), the [JavaScript SDK guide](/docs/sdk/javascript), or the [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart).

## Fastest Way To Start

Choose the shortest path for your app:

- Full JavaScript app: use [Starter With NPX](/docs/tutorials/oidc/starter-with-npx).
- Existing JavaScript app with your own UI: use the [JavaScript SDK guide](/docs/sdk/javascript) and [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart).
- Manual OAuth2, non-JS stacks, mobile adaptation, or debugging: stay on this page.
...
> Flow split: Use **Client Credentials** for **Content APIs** (see [Content APIs Quickstart Guide](/docs/quickstart)). Use **Authorization Code (+PKCE)** for **User APIs** (this page).
...
## Manual Role Of This Page

This page owns the protocol details. The [Starter With NPX](/docs/tutorials/oidc/starter-with-npx) page owns the complete generated app path, and the [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart) owns the SDK-backed path for existing apps.

If you only need app-level Quran content, start with the [Content APIs Quickstart](/docs/quickstart).

Quran Foundation OAuth2 lets users sign in with Quran.com identity and lets your app call User APIs for synced features such as bookmarks, collections, notes, reading sessions, preferences, goals, and streaks.
...
> **Ready to code?** Use the [User APIs Quickstart](/docs/tutorials/oidc/user-apis-quickstart) for the recommended architecture and minimal API call, or see the [Web Integration Example](/docs/tutorials/oidc/example-integration) and the [hosted demo](https://oauth2-client-prelive.quran.foundation/).

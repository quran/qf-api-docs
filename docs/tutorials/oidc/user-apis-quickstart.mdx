...
This example keeps the login UI and PKCE flow in the app, but sends the authorization code to your backend for token exchange. That works with the confidential clients currently issued through Request Access.

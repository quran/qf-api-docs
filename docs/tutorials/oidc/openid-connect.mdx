...
Besides OAuth2, Quran.Foundation also supports [OpenId Connect](https://openid.net/connect) standards by providing the [UserInfo Endpoint](/docs/auth_versioned/get-oidc-user-info) to get more information about the user.

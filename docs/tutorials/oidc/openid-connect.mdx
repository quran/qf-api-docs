...
Besides OAuth2, Quran.Foundation also supports [OpenId Connect](https://openid.net/connect) standards by providing the [UserInfo Endpoint](/docs/user_related_apis_versioned/get-oidc-user-info) to get more information about the user.

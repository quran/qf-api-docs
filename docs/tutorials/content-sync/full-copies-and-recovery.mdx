...
- Once published, full copy of `quran_core:1` returns canonical Uthmani verse text, Surah metadata, and Juz/Hizb/Rub-el-Hizb boundaries. It has no Mushaf-specific pages.
...
Continue using `mushafs:<id>` for page/line/glyph/font layout. Publication of
canonical text remains pending source/edition, redistribution, and attribution
approval. Until then, a snapshot is unavailable.

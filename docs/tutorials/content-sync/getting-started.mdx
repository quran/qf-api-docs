...
| ------------------------------ | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `mushafs`                      | Quran text, word positions, pages, and layout data. Font files and page images are separate. | Mushaf, page, and word changes.                                                       |
...
Mushaf Content Sync provides Quran text, word positions, pages, and layout data. It does not include font files or page images. For rendering assets, see [Mushaf Fonts and Images](/legal/mushaf-fonts-and-images/) and the [Font Rendering guide](/docs/tutorials/fonts/font-rendering/).
...
A full copy returns all current rows for one resource. For example, a Mushaf full copy returns its metadata, pages, and words. Font files and page images are separate.

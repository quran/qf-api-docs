...
Mushaf Content Sync provides Mushaf metadata, page mappings, and positioned words. It does not include font files or Mushaf image files. These files must be fetched separately from the documented Quran Foundation CDN URLs. They may be cached or bundled for use in your application if you have an active Developer Console account and credit Quran Foundation; see the [Developer Terms](/legal/developer-terms/) for the full conditions. For font implementation guidance, see the [Font Rendering guide](/docs/tutorials/fonts/font-rendering/).

...
| ------------------------------ | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `mushafs`                      | Quran text, word positions, pages, layout data, and font asset metadata such as CDN URLs. Font files and page images are separate. | Mushaf, page, font asset metadata, and word changes.                                  |

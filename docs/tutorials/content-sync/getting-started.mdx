...
Mushaf Content Sync provides Mushaf metadata, page mappings, and positioned words. It does not include font files or images. For rendering, see [Mushaf Fonts and Images](/legal/mushaf-fonts-and-images/) and the [Font Rendering guide](/docs/tutorials/fonts/font-rendering/).

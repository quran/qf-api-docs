...
| ------------------------------ | ------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `mushafs`                      | Layout metadata, page mappings, distributable font assets, and positioned words.      | Mushaf, page, font asset, and word changes.                                          |
...
A full copy returns all current rows for one resource. For example, a Mushaf full copy returns its metadata, pages, publicly distributable font assets, and words.

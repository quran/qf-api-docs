...
- `resource_group`, such as `mushafs`, `translations`, or `word_by_word_translations`
- `resource_id`, such as Mushaf ID `1`, translation resource content ID `19`, or word-by-word translation resource content ID `85`
...
The current sync contract accepts only `articles`, `mushafs`, `recitations`, `tafsirs`, `translations`, and `word_by_word_translations` as resource groups.

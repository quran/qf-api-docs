...
Create an app in the [Developer Console](https://dev-console.quran.foundation/projects/new) to receive your `client_id`. Confidential backend apps also receive a one-time `client_secret`; public browser or mobile apps use PKCE without a secret. These credentials let you request authorization tokens for accessing user data.

...
Create an app in the [Developer Console](https://dev-console.quran.foundation/projects) to receive your `client_id` and `client_secret`. These credentials let you request authorization tokens for accessing user data.

...
Include the `post_logout_redirect_uri` parameter when calling the logout endpoint. The redirect URI must be pre-registered in your OAuth2 client's `post_logout_redirect_uris` configuration.

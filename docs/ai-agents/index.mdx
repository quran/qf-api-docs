...
- <a href="/.well-known/agent-prompts/index.json">Prompt registry JSON</a>
- <a href="/agent-prompts/qf-next-starter.md">Next.js starter prompt</a>
- <a href="/agent-prompts/qf-sveltekit-starter.md">SvelteKit starter prompt</a>
- <a href="/agent-prompts/qf-js-sdk-integration.md">JS SDK integration prompt</a>
- <a href="/agent-prompts/qf-python-sdk-integration.md">Python SDK integration prompt</a>
- <a href="/agent-prompts/qf-oauth-user-apis.md">OAuth/User APIs prompt</a>
- <a href="/agent-prompts/qf-review-existing-integration.md">Review existing integration prompt</a>

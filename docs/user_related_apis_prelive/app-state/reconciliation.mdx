...
when the application provides durable transactional storage. For runnable imports, calls, pagination,
conditional mutations, error handling, and account-bound transport switching, use the dedicated
[JavaScript App State SDK guide](/docs/sdk/javascript/app-state/) or

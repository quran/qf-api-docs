    ...
    "parameters":
      [
        ...
        },
        {
          ...
          "schema":
            { "type": "string", "example": "veimvfgqexjicockrwsgcb333o3a" },
        },
      ],
    "responses":
      {
    ...
    "postman":
      {
        ...
        "description":
          {
            "content": "This endpoint is used to start the authorization process. The client redirects the user to this endpoint to request authorization. The user will be prompted to log in and grant permission to the client application.\n\nUse open source libraries to perform OAuth 2.0 and OpenID Connect available for any programming language. You can find a list of libraries at https://oauth.net/code/\n\nFor now, you can only use grant_type `authorization_code` and `refresh_token` in the /oauth2/token endpoint",
            "type": "text/plain",
          },
        "url":
          {
              ...
              [
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The type of response expected from the OAuth2 server",
                      "type": "text/plain",
                    },
                  "key": "response_type",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The client id that you already created",
                      "type": "text/plain",
                    },
                  "key": "client_id",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) Where to redirect after the oauth2 process completed",
                      "type": "text/plain",
                    },
                  "key": "redirect_uri",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "(Required) The scopes that you want to request, separated by spaces",
                      "type": "text/plain",
                    },
                  "key": "scope",
                  "value": "",
                },
                {
                  ...
                  "description":
                    {
                      "content": "An opaque value used by the client to maintain state between the request and callback. The authorization server includes this value when redirecting the user-agent back to the client.",
                      "type": "text/plain",
                    },
                  "key": "state",
                  "value": "",

...
Use content resource sync when your app keeps a local copy of public Mushafs, tafsirs, translations, word-by-word translations, ayah recitations, chapter recitations, or articles and needs to update it without downloading every row again.
...
const bootstrap = await client.content.v4.resources.sync({
  bootstrap: true,
  resources: "chapter_recitations:159;mushafs:1",
});

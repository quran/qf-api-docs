...
| Frontend/mobile public client | `@quranjs/api/public` | No for OAuth; an API proxy may be needed for browser-origin restrictions | No | No | Yes, with approved scopes | Yes | No |

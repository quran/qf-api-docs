...
This document outlines how to migrate from the old `quran.v4` API to the new class-based `QuranClient` in the [`@quranjs/api`](/docs/sdk/javascript) package.

...
Document version is opaque and strictly monotonic across put, delete, tombstone consumption,
payload pruning, and recreation. Pruning may remove tombstone payload/history only after a valid
watermark and must retain the lineage version.

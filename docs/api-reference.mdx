---
title: "API Reference"
description: "Choose the right Quran Foundation API reference for content, search, OAuth2, User APIs, and pre-live user API validation."
...
If you do not have a Quran Foundation client yet, create your app in the [Developer Console](https://dev-console.quran.foundation/projects). If you are still choosing an app shape, start with the [Developer Journey](/docs/developer-journey).
...
| User APIs | Bookmarks, collections, notes, reading sessions, goals, preferences, profiles, rooms, posts, comments, and tags. | OAuth2 user session token plus client ID. | [Open User APIs](/docs/user_related_apis_versioned/1.0.0/user-related-apis/) |
...
| User APIs (Pre-live) | Upcoming user API behavior before it is promoted to production docs. | Pre-live OAuth2 user session token plus client ID. | [Open Pre-live User APIs](/docs/user_related_apis_prelive/user-related-apis/) |

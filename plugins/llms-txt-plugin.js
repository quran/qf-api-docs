...
const OPENAPI_HEADER = [
  ...
  '',
  '- [Mushaf Fonts and Images](https://api-docs.quran.foundation/legal/mushaf-fonts-and-images/): Content Sync scope, rendering methods, and documented providers or delivery sources',
  '',

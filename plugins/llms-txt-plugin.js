...
const OPENAPI_HEADER = [
  ...
  '',
  '**Prelive Content API limitation:** The prelive environment is for testing and development only. Its Quran content dataset includes only Al-Fatihah (surah 1) and Al-Baqarah (surah 2). Test content requests using these surahs. For the complete Quran dataset, use the production environment after production access is approved.',
  '',
  'This limitation applies to Quran content in the Content API, not to User-related APIs. See the [Content APIs Quickstart](https://api-docs.quran.foundation/docs/quickstart/) for environment URLs and setup.',
  '',
  ...
  '',
  '- [Developer Terms](https://api-docs.quran.foundation/legal/developer-terms/): Content usage, caching, bundling, attribution, and redistribution requirements',
  '- [Font Rendering](https://api-docs.quran.foundation/docs/tutorials/fonts/font-rendering/): Quran font URLs and rendering guidance',
  '',

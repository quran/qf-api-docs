...
Content Sync’s offline-storage exception applies only to data returned by Content Sync. It does not cover Mushaf font files or images. For permission to cache third-party font or image assets for offline use, contact the provider identified on the [Mushaf Fonts and Images](/legal/mushaf-fonts-and-images/) page directly.

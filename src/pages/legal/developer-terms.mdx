...
Content Sync’s offline-storage exception applies only to the content identified in the Content Sync documentation. Mushaf font files and page images are delivered separately and remain subject to the provider conditions listed in [Mushaf Fonts and Images](/legal/mushaf-fonts-and-images/).

...
Content Sync’s offline-storage exception applies only to data returned by Content Sync. Mushaf font files and images are not included. See [Mushaf Fonts and Images](/legal/mushaf-fonts-and-images/) for the documented rendering options.

<!-- PATCH:GET /api/v4/chapter_recitations/{reciter_id} -->
### Patch Snippet for `GET /api/v4/chapter_recitations/{reciter_id}`
...
_Generated from `config/routes/api/v4.rb:134`_

<!-- PATCH:GET /api/v3/foot_notes/{foot_note_id}/chapters/{chapter_id}/juzs/{juz_id} -->
### Patch Snippet for `GET /api/v3/foot_notes/{foot_note_id}/chapters/{chapter_id}/juzs/{juz_id}`
...
_Generated from `config/routes/api/v3.rb:34`_

  ...
  tutorialsSidebar: [
    ...
    },
    {
      ...
      link: {
        ...
        description: "Build offline-first mobile apps with authentication and data sync capabilities.",
      },
      items: [
        {
          type: "category",
          ...
          link: {
            type: "generated-index",
            description: "Integrate OAuth2/OpenID Connect authentication in your mobile app.",
          },
          items: [
        ...
        },
        {
          ...
          link: {
            type: "generated-index",
            description: "Implement offline-first data synchronization for your mobile app.",
          },
          items: [
    ...
    },
    {
      ...
      link: {
        type: "generated-index",
        description: "Get started with OAuth2 authentication for Quran.Foundation APIs.",
      },
      items: [

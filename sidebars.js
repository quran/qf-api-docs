...
const buildTutorialsSidebarItems = () => [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      "tutorials/content-sync/getting-started",
      "tutorials/content-sync/client-flow",
      "tutorials/content-sync/offline-cache-patterns",
      "tutorials/content-sync/full-copies-and-recovery",
    ],
  },
];
